...
public class ProdutoSearchView extends javax.swing.JFrame {
    ...
    private void jbPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbPesquisarActionPerformed
        ...
        List<Produto> produto = ProdutoController.getInstance().pesquisar(jtfPesquisar.getText());
        ...
        for (Produto i : produto) {
            modelo.addRow(new Object[]{i.getId(), i.getNome(),i.getValor(),  i.getDescricao() });
        }
    ...
    private void jbAlterar2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbAlterar2ActionPerformed
        ...
        if (linha > 0)
        {
            ...
            Produto i = ProdutoController.getInstance().buscarID(id);
